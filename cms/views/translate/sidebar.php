...
<p class="button"><a href="<?php echo URL::site('translate/core'); ?>"><img src="images/file.png" align="middle" alt="document icon" /> <?php echo __('Create Core template'); ?></a></p>
<p class="button"><a href="<?php echo URL::site('translate/plugins'); ?>"><img src="images/file.png" align="middle" alt="document icon" /> <?php echo __('Create Plugin templates'); ?></a></p>
