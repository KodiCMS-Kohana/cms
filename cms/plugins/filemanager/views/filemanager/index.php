...
<div class="widget widget-nopad">
	...
	<div id="filemanager-container" class="widget-content">
		...
		<div id="filemanager-list">
			<table class=" table table-striped table-hover">
				...
				<tbody>
					<?php if (!empty($path)): ?>
					<tr>
						<td colspan="5"><?php echo UI::icon('folder-open'); ?> <a href="<?php echo URL::backend('filemanager/'.(!empty($path) ? substr($path, 0, strrpos($path, '/')): '')); ?>"><?php echo __('Level up'); ?></a></td>
					</tr>
					<?php endif; ?>
