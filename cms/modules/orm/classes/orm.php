...
class ORM extends Model implements serializable {
	...
	{
		if ($this->_loaded)
			throw new Core_Exception('Method find() cannot be called on loaded objects');
	...
	{
		if ($this->_loaded)
			throw new Core_Exception('Method find_all() cannot be called on loaded objects');
	...
	{
		if ($this->_loaded)
			throw new Core_Exception('Cannot create :model model because it is already loaded.', array(':model' => $this->_object_name));
	...
	{
		if ( ! $this->_loaded)
			throw new Core_Exception('Cannot update :model model because it is not loaded.', array(':model' => $this->_object_name));
	...
	{
		if ( ! $this->_loaded)
			throw new Core_Exception('Cannot delete :model model because it is not loaded.', array(':model' => $this->_object_name));
