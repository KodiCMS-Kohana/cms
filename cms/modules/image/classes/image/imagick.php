...
class Image_Imagick extends Image {
	...
	public static function check()
	{
		...
		{
			throw new Core_Exception('Imagick is not installed, or the extension is not loaded');
		}
	...
	protected function _get_imagetype($extension)
	{
		...
		switch ($format)
		{
			...
			break;
			default:
				throw new Core_Exception('Installed ImageMagick does not support :type images',
