<?php defined('MODPATH') or die('No direct script access.');
/**
 ...
 *
 * [!!] This file is licensed differently from the rest of Core. As a port of
 * [phputf8](http://phputf8.sourceforge.net/), this file is released under the LGPL.
 *
 * @package    Core
 * @category   Base
 * @author     Core Team
 * @copyright  (c) 2007-2011 Core Team
...
class UTF8 {
	...
	public static function transliterate_to_ascii($str, $case = 0)
	{
		...
		{
			require MODPATH.'utf8'.DIRECTORY_SEPARATOR.__FUNCTION__.EXT;
