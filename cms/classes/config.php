...
class Config {
	 ...
	 *
	 * @param   object   Config_Source instance
	...
	public function load($group)
	{
		...
		{
			throw new Core_Exception('No configuration sources attached');
		}

		if (empty($group))
		{
			throw new Core_Exception("Need to specify a config group");
		}

		if ( ! is_string($group))
		{
			throw new Core_Exception("Config group must be a string");
		}
