...
class Debug {
	...
	/**
	 * Removes application, system, modpath, or docSYSPATH from a filename,
...
//		elseif (strpos($file, DOCSYSPATH) === 0)
//		{
//			$file = 'DOCSYSPATH'.DIRECTORY_SEPARATOR.substr($file, strlen(DOCSYSPATH));
//		}
