...
ALTER TABLE `TABLE_PREFIX_pages`
  ADD CONSTRAINT `TABLE_PREFIX_pages_ibfk_1` FOREIGN KEY (`created_by_id`) REFERENCES `TABLE_PREFIX_users` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,

ALTER TABLE `TABLE_PREFIX_page_parts`
  ADD CONSTRAINT `TABLE_PREFIX_page_parts_ibfk_1` FOREIGN KEY (`page_id`) REFERENCES `TABLE_PREFIX_pages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `TABLE_PREFIX_page_roles`
  ADD CONSTRAINT `TABLE_PREFIX_page_roles_ibfk_1` FOREIGN KEY (`page_id`) REFERENCES `TABLE_PREFIX_pages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `TABLE_PREFIX_page_roles_ibfk_2` FOREIGN KEY (`role_id`) REFERENCES `TABLE_PREFIX_roles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `TABLE_PREFIX_page_tags`
  ADD CONSTRAINT `TABLE_PREFIX_page_tags_ibfk_1` FOREIGN KEY (`page_id`) REFERENCES `TABLE_PREFIX_pages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `TABLE_PREFIX_page_tags_ibfk_2` FOREIGN KEY (`tag_id`) REFERENCES `TABLE_PREFIX_tags` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `TABLE_PREFIX_roles_users`
  ADD CONSTRAINT `TABLE_PREFIX_roles_users_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `TABLE_PREFIX_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `TABLE_PREFIX_roles_users_ibfk_2` FOREIGN KEY (`role_id`) REFERENCES `TABLE_PREFIX_roles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `TABLE_PREFIX_user_tokens`
  ADD CONSTRAINT `TABLE_PREFIX_user_tokens_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `TABLE_PREFIX_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
