<div class="hero-unit">
	...
	<hr />
	<p class="text-center">
		<?php echo HTML::anchor(ADMIN_DIR_NAME, __('Backend'), array('class' => 'btn btn-large')); ?> <?php echo HTML::anchor('http://kodicms.ru/forum/', 'Форум', array('class' => 'btn btn-large btn-primary')); ?>
	</p>
</div>
