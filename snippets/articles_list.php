...
<nav class="pager">
	...
	<a class="pager-old" href="<?php echo URL::site('articles'); ?>?offset=<?php echo ($offset+10); ?>">Older posts</a>
	<?php endif; ?>

	<a class="pager-home" href="<?php echo URL::site('articles'); ?>">Home</a>

	<?php if($offset >= 10): ?>
	<a class="pager-new" href="<?php echo URL::site('articles'); ?>?offset=<?php echo ($offset-10); ?>">Newer posts</a>
	<?php endif; ?>
</nav>